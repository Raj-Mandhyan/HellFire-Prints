                ...
                <div className="space-y-6">
                  ...
                  <div className="space-y-4">
                    {cart.items.map((item) => (
                      <div
                        key={item.id}
                        className={`flex flex-col sm:flex-row items-start sm:items-center justify-between bg-[#0F0F0F] p-5.5 rounded-3xl border border-neutral-900/80 gap-4 transition-all duration-300 shadow-sm hover:border-neutral-800 ${updatingItemId === item.id ? 'opacity-40 pointer-events-none' : ''
                          }`}
                      >
                        {/* Left: Poster Details */}
                  ...
                  <div className="bg-[#0F0F0F] p-6 sm:p-8 border border-neutral-900 rounded-3xl space-y-6 shadow-md relative overflow-hidden">
                    ...
                    <div className="space-y-4 text-xs font-extrabold uppercase tracking-widest">
                      ...
                      <div className="flex justify-between items-center">
                        ...
                        <span className={`font-black uppercase tracking-widest text-[9px] px-2.5 py-1 rounded-lg ${cart.shippingFee === 0
